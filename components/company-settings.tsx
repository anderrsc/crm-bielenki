...
import { Building2, ImagePlus, Megaphone, Ruler, Save, Palette, LayoutTemplate } from "lucide-react";
...
return <div className="mx-auto max-w-5xl"><div className="mb-7 flex flex-col justify-between gap-4 sm:flex-row sm:items-end"><div><div className="mb-3 flex h-11 w-11 items-center justify-center rounded-xl bg-forest text-white"><Building2 className="h-5 w-5" /></div><h1 className="text-3xl font-black">Identidade da empresa</h1><p className="mt-1 text-sm text-ink/50">Estes dados aparecem nos orçamentos e fichas de visita.</p></div><div className="flex flex-wrap gap-2"><Link href="/configuracoes/identidade" className="button flex items-center gap-2"><Palette className="h-4 w-4"/>Logo e Visual</Link><Link href="/configuracoes/templates" className="button-ghost flex items-center gap-2"><LayoutTemplate className="h-4 w-4"/>Templates</Link><Link href="/configuracoes/origens-lead" className="button-ghost"><Megaphone className="h-4 w-4"/>Origens de lead</Link><Link href="/configuracoes/tabela-calhas" className="button-ghost"><Ruler className="h-4 w-4"/>Tabela de preços</Link></div></div>
